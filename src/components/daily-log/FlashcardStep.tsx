    ...
    return (
      ...
      >
        ...
        <p className="text-sm" style={{ color: 'var(--c-text-2)' }}>
          Generate vocabulary first to start flashcard review
        </p>
      </div>
    )
  }
      ...
      >
        ...
        <div>
          ...
          <p className="mt-1" style={{ color: 'var(--c-text-2)' }}>
            ...
            {' '}out of{' '}
            <span className="font-bold" style={{ color: 'var(--c-text-1)' }}>{total}</span>
            {' '}words
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-5xl font-bold tracking-tight" style={{ color: 'var(--c-text-1)' }}>
                {current?.word}
              </p>
            ...
            >
              <p className="text-3xl font-bold mb-4" style={{ color: 'var(--c-text-1)' }}>
                {current?.word}
              </p>
              ...
              <div className="w-full space-y-3">
                ...
                >
                  <p className="text-xs text-violet-500 font-medium mb-1">Nghĩa</p>
                ...
                >
                  <p className="text-xs text-cyan-500 font-medium mb-1">Ví dụ</p>
                ...
                {current?.my_sentence && (
                  ...
                  >
                    <p className="text-xs text-emerald-500 font-medium mb-1">Câu của bạn</p>
      ...
      <AnimatePresence>
        {flipped && (
          ...
          >
            ...
            >
              <XCircle className="w-5 h-5" /> Chưa nhớ
            </button>
            <button
              onClick={() => next('know')}
            ...
            >
              <CheckCircle2 className="w-5 h-5 text-emerald-500" /> Biết rồi!
            </button>
          </motion.div>
        )}
      </AnimatePresence>
